...
for file in json_files:
    with open(file) as json_file:
        ...
        if json_data['corpus'] == "ieee_expanded":        
            ...
            elif json_data['train'] == 553:
                training_lenght_553[float(json_data['expanded_weighting'])] = json_data['f1_score']                            
            print(json_data)
print ''
print ''
...
training_lenght_553 = sorted(training_lenght_553.iteritems(), key=operator.itemgetter(0))

print training_lenght_5
print training_lenght_50
print training_lenght_100
print training_lenght_553
...
p_training_lenght_553, = plt.plot(weighting_set, [x[1] for x in training_lenght_553],'kx-')
plt.legend([p_training_lenght_5,p_training_lenght_50,p_training_lenght_100,p_training_lenght_553], ["Training Lenght = 5","Training Lenght = 50","Training Lenght = 100","Training Lenght = 553"], loc = "lower right")
#plt.show()
