...
#p_boc_exp_09_09, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_09_09],'kx-')
#p_boc_exp_09_08, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_09_08],'c*-')
#p_boc_exp_08_09, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_08_09],'y.-')
p_boc_exp_08_08, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_08_08],'mx-')
#p_boc_exp_07_07, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_07_07],'co-')
#p_boc_exp_08_07, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_08_07],'g+-')
#p_boc_exp_07_08, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_07_08],'b*-')
#p_boc_exp_09_07, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_09_07],'k.-')
#p_boc_exp_07_09, = plt.plot(train_set, [x[1] for x in boc_ohsumed_expanded_07_09],'rx-')

#plt.legend([p_bow,p_boc,p_boc_exp_09_09,p_boc_exp_09_08,p_boc_exp_08_09,p_boc_exp_09_07,p_boc_exp_07_09,p_boc_exp_08_08,p_boc_exp_08_07,p_boc_exp_07_08,p_boc_exp_07_07,], ["BoW", "BoC","BoC expanded_09_09","BoC expanded_09_08","BoC expanded_08_09","BoC expanded_09_07","BoC expanded_07_09","BoC expanded_08_08","BoC expanded_08_07","BoC expanded_07_08","BoC expanded_07_07"], loc = "lower right", prop={'size':12})
