...
json_files =  glob.glob("Results/json/experiment_influence_expanded_weighting_20_newsgroups_0.8_0.8/*.json")
...
for file in json_files:
    with open(file) as json_file:
        ...
        if json_data['corpus'] == "20_newsgroup_expanded":
...
plt.legend([p_training_lenght_5,p_training_lenght_50,p_training_lenght_100,p_training_lenght_150], ["Training Lenght = 5","Training Lenght = 50","Training Lenght = 100","Training Lenght = 150"], loc = "best")
#plt.show()
