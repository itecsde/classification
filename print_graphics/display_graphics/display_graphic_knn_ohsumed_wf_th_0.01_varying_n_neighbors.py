...
json_files =  glob.glob("Results/json/KNN/experiment_knn_ohsumed_wf_th_0.01_varying_n_neighbors/*.json")
n_neighbors_set = [1, 2, 5, 10, 15, 20, 50, 100, 250]
...
for file in json_files:
	...
	if json_data['corpus'] ==  "ohsumed_expanded":
