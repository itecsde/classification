...
"bow_ohsumed_randomized_multilabel","bow_reuters_rcv1", "bow_reuters_rcv2","boc_reuters_rcv1", "boc_reuters_rcv2","bow_reuters_rcv2_translated_to_english_google_translate", "boc_wikipedia_english", "boc_wikipedia_spanish"]
...
parser.add_argument('-corpus_training', dest='corpus_training', default = "none", choices=['bow_reuters_rcv1', 'bow_reuters_rcv2','boc_reuters_rcv1', 'boc_reuters_rcv2','boc_wikipedia_english'])
