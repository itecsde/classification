...
# INPUT PARAMETERS
if (args.corpus_training == "none" and args.corpus_test == "none") or args.classify_method == "multilabel":
    if args.corpus == 'all':
    ...
    for number_of_documents_for_training in array_number_of_documents_for_training:
        for threshold in array_threshold:
            ...
            if classify_method == "all_classifiers" or classify_method == "multilabel" or classify_method == "multilabel_cross_language_linear_SVM":
                ...
                elif corpus_training == "boc_jrc_acquis_english" or corpus_training == "boc_jrc_acquis_spanish_to_english":
